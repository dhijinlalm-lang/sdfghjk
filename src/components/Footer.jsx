      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-white">ebook library</h3>
            </div>
            <p className="text-gray-400 text-sm">Your gateway to endless digital knowledge and entertainment.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-purple-400 transition">Browse Books</a></li>
              <li><a href="#" className="hover:text-purple-400 transition">My Library</a></li>
              <li><a href="#" className="hover:text-purple-400 transition">Featured</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-purple-400 transition">Report Issue</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="flex flex-wrap gap-6 justify-center text-sm mb-6">
            ...
            <span className="text-gray-700">|</span>
            <a href="#" className="text-gray-400 hover:text-purple-400 transition">DMCA</a>
            <span className="text-gray-700">|</span>
          ...
          <div className="text-center text-gray-500 text-sm">
            <p>&copy; {currentYear} ebook library. All rights reserved. | Made with ❤️</p>
          </div>
        </div>
      </div>
    </footer>
